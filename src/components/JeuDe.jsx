...
export default class JeuDe extends Component {
    ...
    render() {
        return (
            <div className='jeu'>
                <img src={require('../images/jeude.jpeg')} alt='logo' />
                <h1>Jeu de Dé</h1>
                <h2>face: {this.state.face} </h2>
                {
                    this.state.face === null ? 
                    <img className='imgde' src={require('../images/facevide.jpeg')} alt="" />
                    :
                    <img className='imgde' src={require('../images/face'+this.state.face+'.jpeg')} alt="" />
                }
